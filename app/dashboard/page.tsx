      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div className="relative">
            ...
            />
            <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-x-2 gap-y-2 px-2">
              {ideas.map((idea, index) => {
                // Calculate column based on responsive grid
                const getColumn = () => {
                  // This is approximate - actual columns depend on screen size
                  return index % 3; // mobile default
                };
                ...
                return (
                  <div
                    ...
                    style={{
                      // Add slight overlap for rows after the first
                      marginTop: index >= 3 ? '-30px' : '0',
                      // Add slight z-index variation for layering effect
                      zIndex: 10 - (index % 10),
                    }}
                  >
                    <PostIt
